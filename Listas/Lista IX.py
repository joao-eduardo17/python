...
def pego_correndo(speed, is_birthday):
  if speed <= 60 :
    ...
    return 1
  elif 80 <= speed and not is_birthday:
    return 2
  elif 66 <= speed <= 85 and is_birthday:
    return 1
  elif 86 <= speed and is_birthday:
    return 2
  else:
    return 0
...
def alarm_clock(day, vacation):
  if day == 0 and not vacation or day == 6 and not vacation:
    return '10:00'
  elif day != 0 and not vacation or day != 6 and not vacation:
    return '7:00'
